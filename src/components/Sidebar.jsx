...
const ASSET_CATALOGUE = [
  ...
  { types:['boomgate'],      label:'Site Boom Gates',       pip:'boomgate',   purpose:'Automated site access control and authorized entry management',          standard:'Position at site entry/exit points; clear sightlines required',   unit:'EA', cost: 1200   },
